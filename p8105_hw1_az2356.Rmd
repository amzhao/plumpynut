...
The color scales are similar for the logical and factor variables because they are whole integers of essentially presence (1, true) or absence (0, false). The numeric variable can vary and so the color scale in the key has a gradient. However, the color in the plot is still the color for 1 or 0 because it can only be that x + y > 1 or not. 
